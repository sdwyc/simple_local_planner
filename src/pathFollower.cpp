...
int main(int argc, char** argv)
{
  ...
  if (autonomyMode) {
    ...
    std::cout << "joySpeed=  " << joySpeed << std::endl; 
    if (joySpeed < 0) joySpeed = 0;
    else if (joySpeed > 1.0) joySpeed = 1.0;
  }
  ...
  while (status) {
    ...
    if (pathInit) {
      ...
      std::cout << "endDis=  " << endDis << std::endl; 
      ...
      // std::cout << "before dealing: vehicleYaw=  " << vehicleYaw << std::endl; 
      // std::cout << "before dealing: pathDir=  " << pathDir << std::endl; 
      // std::cout << "before dealing: dirDiff=  " << dirDiff << std::endl; 
      if (dirDiff > PI) dirDiff -= 2 * PI;
      else if (dirDiff < -PI) dirDiff += 2 * PI;
      if (dirDiff > PI) dirDiff -= 2 * PI;
      else if (dirDiff < -PI) dirDiff += 2 * PI;
      // std::cout << "after dealing: dirDiff=  " << dirDiff << std::endl; 
      ...
      std::cout << "maxSpeed=  " << maxSpeed << std::endl; 
      std::cout << "joySpeed=  " << joySpeed << std::endl; 
      std::cout << "joySpeed2  1=  " << joySpeed2 << std::endl; 
      ...
      std::cout << "joySpeed2  2=  " << joySpeed2 << std::endl; 

      if (fabs(vehicleSpeed) < 2.0 * maxAccel / 100.0) vehicleYawRate = -stopYawRateGain/2 * dirDiff;
      else vehicleYawRate = -yawRateGain/2 * dirDiff;
      ...
      std::cout << "joySpeed2  3=  " << joySpeed2 << std::endl; 
      ...
      std::cout << "joySpeed2  4=  " << joySpeed2 << std::endl; 
      ...
      std::cout << "dirDiffThre=  " << dirDiffThre << std::endl; 
      std::cout << "dis=  " << dis << std::endl; 
      std::cout << "stopDisThre=  " << stopDisThre << std::endl; 
      ...
      if (pubSkipCount < 0) {
        ...
        //   cmd_vel.linear.x = 0;
        //   std::cout<< "vehicleSpeed) <= maxAccel / 100.0" << std::endl;
        // }
        // else cmd_vel.linear.x = vehicleSpeed;
        cmd_vel.linear.x = vehicleSpeed;
        std::cout<< "linear vel: " << cmd_vel.linear.x << std::endl;
        cmd_vel.angular.z = vehicleYawRate;
        pubSpeed.publish(cmd_vel);
